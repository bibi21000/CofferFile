...
@pytest.mark.parametrize("chunk_size, file_size",
    [
        (1024 * 1, 1024 * 10), (1024 * 1, 1024 * 10 + 3), (1024 * 1, 1024 * 10 + 6),
        (1024 * 10, 1024 * 10), (1024 * 10, 1024 * 10 + 13), (1024 * 10, 1024 * 10 + 9),
        (1024 * 100, 1024 * 10), (1024 * 100, 1024 * 10 + 5), (1024 * 100, 1024 * 10 + 11),
    ])
...
@pytest.mark.parametrize("chunk_size, file_size",
    [
        (1024 * 1, 1024 * 10 + 1), (1024 * 1, 1024 * 10 + 4), (1024 * 1, 1024 * 10 + 5),
        (1024 * 10, 1024 * 10 + 1), (1024 * 10, 1024 * 10 + 7), (1024 * 10, 1024 * 10 + 3),
        (1024 * 100, 1024 * 10 + 1), (1024 * 100, 1024 * 10 + 9), (1024 * 100, 1024 * 10 + 11),
    ])
